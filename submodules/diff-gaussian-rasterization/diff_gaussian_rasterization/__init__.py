...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        if raster_settings.debug:
            ...
            try:
                num_rendered, color, depth, alpha, point_list, means2D, conic_opacity, gauss_depth, start_end, radii, geomBuffer, binningBuffer, imgBuffer = _C.rasterize_gaussians(*args)  # ljf
        ...
        return color, depth, alpha, point_list, means2D, conic_opacity, gauss_depth, start_end, radii  # ljf

    @staticmethod
    def backward(ctx, grad_color, grad_depth, grad_alpha, *args):   # ljf
